        ...
        <main className="flex-1 flex flex-col overflow-y-auto bg-slate-50 font-sans text-slate-900">
            ...
            <div className="p-8 space-y-8 max-w-7xl mx-auto w-full">
                ...
                <section>
                    ...
                    <div className="border-2 border-dashed border-slate-300 rounded-xl bg-white p-12 text-center transition-all hover:border-blue-400 hover:bg-blue-50/50 cursor-pointer">
                        <div className="flex flex-col items-center">
                            ...
                            <button className="mt-6 px-6 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-lg shadow-sm hover:bg-blue-700 transition-colors" onClick={() => document.getElementById('fileInput').click()}>
                                Select Files
                            </button>
                        </div>
                    </div>
